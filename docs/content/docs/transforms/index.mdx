...
Monoize ships 36 built-in transforms. Each transform has its own page in this section.
...
| Field | Set, remove, or cap raw request/response fields | `field_alias_reserved_tool_names`, `field_custom_tools_to_function`, `field_override_max_tokens`, `field_remove`, `field_set`, `field_strip_sampling` |
