...
async fn dashboard_api_key_group_selection_round_trip_through_store_and_responses() {
    ...
    let (created, key) = store
        .create_api_key_extended(
            ...
            CreateApiKeyInput {
                ...
                model_bindings: create_body.model_bindings,
    ...
    let created_value = serde_json::to_value(ApiKeyCreatedResponse {
        ...
        model_bindings: created.model_bindings.clone(),
    ...
    let updated = store
        .update_api_key(
            ...
            UpdateApiKeyInput {
                ...
                model_bindings: update_body.model_bindings,
                max_multiplier: None,
                transforms: None,
    ...
    let response_value = serde_json::to_value(ApiKeyResponse {
        ...
        model_bindings: fetched.model_bindings,
