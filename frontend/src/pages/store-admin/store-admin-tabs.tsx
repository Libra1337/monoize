...
export type StoreAdminTab = "products" | "channels" | "orders" | "redemptions" | "sales";
...
const tabs: StoreAdminTab[] = ["products", "channels", "orders", "redemptions", "sales"];
...
export function StoreAdminTabs({ activeTab, onTabChange }: StoreAdminTabsProps) {
  ...
  return (
    <div
      className="grid w-full grid-cols-2 gap-1 rounded-xl bg-muted p-1 sm:grid-cols-3 lg:grid-cols-5"
      role="tablist"
