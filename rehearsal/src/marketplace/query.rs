...
pub async fn create_sqlite_query_fixture(db: &mut SqliteConnection) -> Result<(), sqlx::Error> {
    for statement in [
        ...
        "CREATE TABLE monoize_providers (id TEXT PRIMARY KEY, group_id TEXT NOT NULL, enabled INTEGER NOT NULL, channel_enabled INTEGER NOT NULL)",
        ...
        "INSERT INTO monoize_providers VALUES ('pa1', 'ga', 1, 1), ('pa2', 'ga', 1, 1), ('pb1', 'gb', 1, 1), ('disabled', 'ga', 0, 1)",
